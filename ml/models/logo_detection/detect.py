...
class Detector:
    def __init__(self, weights, source, img_size=640, conf_thres=0.1, iou_thres=0.45, device='',
                 ...
                 agnostic_nms=False, augment=False, update=False, project='', name='',
    ...
    def detect(self):
        ...
        detectionInf = self.run_inference(model, device, imgsz, names, half, dataset)
        return detectionInf
            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                # Print results
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        inference = LogoDetectionInference(boundingBox=bbox_coordinates, confidence=conf.item())
